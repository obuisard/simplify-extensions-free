...
class SYWTransitionPickerField extends FormField
{
    ...
    protected function getInput()
    {
        ...
        $html .= '        <button id="'.$this->id.'_caret" style="border-radius:0;margin-left:-1px;min-width:auto" class="btn dropdown-toggle hasTooltip" data-toggle="dropdown" title="' . Text::_('LIB_SYW_TRANSITIONPICKER_SELECTTRANSITION') . '">';
