    		...
    		<div class="modal-content">
            	<div class="modal-header">
            		...
            		<?php if ($bootstrap_version == 5) : ?>
            			<h5 id="<?php echo $selector; ?>Label" class="modal-title"><?php echo $title; ?></h5>
            			<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="<?php echo Text::_('MOD_TRULYRESPONSIVESLIDER_CLOSE'); ?>"></button>
            		<?php endif; ?>
            	</div>
            	<div class="modal-body">
            		<iframe class="iframe" height="<?php echo $height; ?>" style="display: block; width: 100%; border: 0; max-height: none; overflow: auto"></iframe>
            	...
            	<div class="modal-footer">
            		<button class="btn btn-secondary" data-<?php echo ($bootstrap_version >= 5 ? 'bs-' : '') ?>dismiss="modal" aria-hidden="true"><?php echo Text::_('MOD_TRULYRESPONSIVESLIDER_CLOSE'); ?></button>
            	</div>
    		</div>
    	</div>
    </div>
