...
class Fonts
{
	...
	public static function loadIconFont($name = 'syw')
	{
	    ...
	    {
	        case 'icomoon' :
	        	self::getWebAssetManager()->registerAndUseStyle('syw.font.icomoon', 'syw/fonts-icomoon' . $minified . '.css', ['relative' => true, 'version' => 'auto'], $attributes);
	        	break;
	        ...
	        default:
	        	self::getWebAssetManager()->registerAndUseStyle('syw.font', 'syw/fonts' . $minified . '.css', ['relative' => true, 'version' => 'auto'], $attributes);
	    }
	}
