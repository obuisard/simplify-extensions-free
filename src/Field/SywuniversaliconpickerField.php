...
class SywuniversaliconpickerField extends FormField
{
	...
	protected function getInput()
	{
	    ...
	    $wam->useStyle('fontawesome'); // loads fontawesome and icomoon B/C from web asset, probably already loaded on the page
	...
	public function setup(\SimpleXMLElement $element, $value, $group = null)
	{
	    ...
	    if ($return) {
			...
			if (!empty($this->value)) {
			    ...
			    if (!in_array($temp_value[0], array('SYWicon', 'icon', 'fas fa', 'fal fa', 'fab fa', 'far fa', 'fad fa'))) {
