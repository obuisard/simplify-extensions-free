...
// 		}
		...
		include JPATH_ROOT . '/plugins/content/articledetails/styles/style.css.php';
		if ($calendar) {
			include JPATH_ROOT . '/plugins/content/articledetails/styles/calendar/'.$calendar.'/style.css.php';
		}
