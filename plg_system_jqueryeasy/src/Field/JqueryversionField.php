...
class JqueryversionField extends FormField
{
	...
	protected function getInput()
	{
		...
		$html .= '<div class="jqueryversion alert alert-info" style="margin: 0">';
		if ($version === 'auto') {
			$html .= '  <span>'.Text::sprintf('PLG_SYSTEM_JQUERYEASY_FIELD_UNDETERMINEDVERSION_LABEL', 'jQuery').'</span>';
		} else if ($version === 'none') {
		    $html .= '  <span>'.Text::sprintf('PLG_SYSTEM_JQUERYEASY_FIELD_JOOMLAISNOTPACKAGEDWITH_LABEL', 'jQuery').'</span>';
		} else {
