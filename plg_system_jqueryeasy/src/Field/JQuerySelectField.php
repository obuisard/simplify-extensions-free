...
class JQuerySelectField extends DynamicSingleSelect
{
	...
	protected function getOptions()
	{
		...
		$options[] = array(3, Text::_('PLG_SYSTEM_JQUERYEASY_VALUE_JQUERYMOBILE') . ' (Pro)', '', $path . '/select_jquery_mobile.png', '', 'disabled');
