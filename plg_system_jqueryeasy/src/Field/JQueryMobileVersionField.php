...
class JQueryMobileVersionField extends FormField
{
	...
	protected function getInput()
	{
		...
		$html .= '<div class="jquerymobileversion alert alert-info" style="margin: 0">';
		$html .= Text::sprintf('PLG_SYSTEM_JQUERYEASY_FIELD_JOOMLAISNOTPACKAGEDWITH_LABEL', 'jQuery Mobile');
		$html .= '</div>';

		$url = 'https://api.cdnjs.com/libraries/jquery-mobile?fields=version';
		$div = 'jquerymobileversion';
