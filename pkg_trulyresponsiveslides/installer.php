...
class Pkg_TrulyResponsiveSlidesInstallerScript
{
	 ...
	 * Available languages
	 */
	protected $availableLanguages = array('en-GB', 'fa-IR', 'fr-FR', 'nl-NL', 'pl-PL', 'ru-RU', 'sl-SI', 'tr-TR');
	...
	public function postflight($action, $installer)
	{
        ...
        echo '<br /><br /><span class="badge badge-dark">'.Text::sprintf('PKG_TRULYRESPONSIVESLIDES_VERSION', $this->release).'</span>';
