...
if (empty($list)) { // $list can be an empty array
    ...
    if (is_array($what_to_link)) {
        ...
        switch ($what_to_link)
        { // for backward compatibility on template overrides
            case 'title':
                $show_link = true;
                $link_title = true;
                $link_head = true;
    ...
    if (is_array($pos_category)) {
        foreach ($pos_category as $choice) {
            ...
            {
                case 'first':
                    $pos_category_first = true;
                    $show_category = true;
                    $pos_category = 'first';
                    break;
                case 'title':
                    $pos_category_before_title = true;
                    $show_category = true;
                    $pos_category = 'title';
                    break;
                case 'last':
                    $pos_category_last = true;
                    $show_category = true;
                    $pos_category = 'last';
                    break;
            }
        ...
        if ($readall_link == 'extern') {
            ...
            switch ($menuitem->type)
            {
                ...
                case 'url':
                    ...
                    break;
                case 'alias':
                    $readall_link = 'index.php?Itemid=' . $menuitem->id;
                    break;
                default:
