...
class FieldSelectField extends ListField
{
	...
	protected function getOptions()
	{
		...
		// gender
		$options[] = HTMLHelper::_('select.option', 'gen', Text::_('MOD_TROMBINOSCOPE_VALUE_GENDER'), 'value', 'text', $disable=true);

		// birthdate
		$options[] = HTMLHelper::_('select.option', 'dob', Text::_('MOD_TROMBINOSCOPE_VALUE_BIRTHDATE'), 'value', 'text', $disable=true);
		$options[] = HTMLHelper::_('select.option', 'age', Text::_('MOD_TROMBINOSCOPE_VALUE_AGE'), 'value', 'text', $disable=true);

		// company
		$options[] = HTMLHelper::_('select.option', 'com', Text::_('MOD_TROMBINOSCOPE_VALUE_COMPANY'), 'value', 'text', $disable=true);

		// department
		$options[] = HTMLHelper::_('select.option', 'dep', Text::_('MOD_TROMBINOSCOPE_VALUE_DEPARTMENT'), 'value', 'text', $disable=true);

		// map
		$options[] = HTMLHelper::_('select.option', 'map', Text::_('MOD_TROMBINOSCOPE_VALUE_MAP'), 'value', 'text', $disable=true);

		// summary
		$options[] = HTMLHelper::_('select.option', 'sum', Text::_('MOD_TROMBINOSCOPE_VALUE_SUMMARY'), 'value', 'text', $disable=true);
