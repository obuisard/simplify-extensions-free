...
class FieldSelectField extends GroupedListField
{
	...
	protected function getGroups()
	{
		...
		$groups['-'][] = HTMLHelper::_('select.option', 'empty', Text::_('MOD_TROMBINOSCOPE_VALUE_EMPTY'), 'value', 'text', $disable = false);

		$groups['-'][] = HTMLHelper::_('select.option', 'c_p', Text::_('MOD_TROMBINOSCOPE_VALUE_POSITION'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'tel', Text::_('MOD_TROMBINOSCOPE_VALUE_TELEPHONE'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'mob', Text::_('MOD_TROMBINOSCOPE_VALUE_MOBILE'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'fax', Text::_('MOD_TROMBINOSCOPE_VALUE_FAX'), 'value', 'text', $disable = false);
		...
		$groups['-'][] = HTMLHelper::_('select.option', 'add', Text::_('MOD_TROMBINOSCOPE_VALUE_ADDRESS'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'sub', Text::_('MOD_TROMBINOSCOPE_VALUE_SUBURB'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'st', Text::_('MOD_TROMBINOSCOPE_VALUE_STATE'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'p_c', Text::_('MOD_TROMBINOSCOPE_VALUE_POSTCODE'), 'value', 'text', $disable = false);
		//$groups['-'][] = HTMLHelper::_('select.option', 'f_a', Text::_('MOD_TROMBINOSCOPE_VALUE_FORMATTEDADDRESS'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'f_f_a', Text::_('MOD_TROMBINOSCOPE_VALUE_FULLYFORMATTEDADDRESS'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'cou', Text::_('MOD_TROMBINOSCOPE_VALUE_COUNTRY'), 'value', 'text', $disable = false);
		$groups['-'][] = HTMLHelper::_('select.option', 'misc', Text::_('MOD_TROMBINOSCOPE_VALUE_MISC'), 'value', 'text', $disable = false);

		// gender
		$groups['-'][] = HTMLHelper::_('select.option', 'gen', Text::_('MOD_TROMBINOSCOPE_VALUE_GENDER') . ' (Pro)', 'value', 'text', $disable = true);

		// birthdate
		$groups['-'][] = HTMLHelper::_('select.option', 'dob', Text::_('MOD_TROMBINOSCOPE_VALUE_BIRTHDATE') . ' (Pro)', 'value', 'text', $disable = true);
		$groups['-'][] = HTMLHelper::_('select.option', 'age', Text::_('MOD_TROMBINOSCOPE_VALUE_AGE') . ' (Pro)', 'value', 'text', $disable = true);

		// company
		$groups['-'][] = HTMLHelper::_('select.option', 'com', Text::_('MOD_TROMBINOSCOPE_VALUE_COMPANY') . ' (Pro)', 'value', 'text', $disable = true);

		// department
		$groups['-'][] = HTMLHelper::_('select.option', 'dep', Text::_('MOD_TROMBINOSCOPE_VALUE_DEPARTMENT') . ' (Pro)', 'value', 'text', $disable = true);

		// map
		$groups['-'][] = HTMLHelper::_('select.option', 'map', Text::_('MOD_TROMBINOSCOPE_VALUE_MAP') . ' (Pro)', 'value', 'text', $disable = true);

		// summary
		$groups['-'][] = HTMLHelper::_('select.option', 'sum', Text::_('MOD_TROMBINOSCOPE_VALUE_SUMMARY') . ' (Pro)', 'value', 'text', $disable = true);
