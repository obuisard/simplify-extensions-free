...
class FieldselectField extends GroupedlistField
{
	...
	protected function getGroups()
	{
		...
		$groups[$group_name][] = HTMLHelper::_('select.option', 'add', Text::_('MOD_TROMBINOSCOPE_VALUE_ADDRESS'), 'value', 'text', $disable = false);
		$groups[$group_name][] = HTMLHelper::_('select.option', 'sub', Text::_('MOD_TROMBINOSCOPE_VALUE_SUBURB'), 'value', 'text', $disable = false);
		$groups[$group_name][] = HTMLHelper::_('select.option', 'st', Text::_('MOD_TROMBINOSCOPE_VALUE_STATE'), 'value', 'text', $disable = false);
		$groups[$group_name][] = HTMLHelper::_('select.option', 'p_c', Text::_('MOD_TROMBINOSCOPE_VALUE_POSTCODE'), 'value', 'text', $disable = false);
		...
		// gender
		$groups[$group_name][] = HTMLHelper::_('select.option', 'gen', Text::_('MOD_TROMBINOSCOPE_VALUE_GENDER') . ' (Pro)', 'value', 'text', $disable = true);

		// birthdate
		$groups[$group_name][] = HTMLHelper::_('select.option', 'dob', Text::_('MOD_TROMBINOSCOPE_VALUE_BIRTHDATE') . ' (Pro)', 'value', 'text', $disable = true);
		$groups[$group_name][] = HTMLHelper::_('select.option', 'age', Text::_('MOD_TROMBINOSCOPE_VALUE_AGE') . ' (Pro)', 'value', 'text', $disable = true);

		// company
		$groups[$group_name][] = HTMLHelper::_('select.option', 'com', Text::_('MOD_TROMBINOSCOPE_VALUE_COMPANY') . ' (Pro)', 'value', 'text', $disable = true);

		// department
		$groups[$group_name][] = HTMLHelper::_('select.option', 'dep', Text::_('MOD_TROMBINOSCOPE_VALUE_DEPARTMENT') . ' (Pro)', 'value', 'text', $disable = true);

		// map
		$groups[$group_name][] = HTMLHelper::_('select.option', 'map', Text::_('MOD_TROMBINOSCOPE_VALUE_MAP') . ' (Pro)', 'value', 'text', $disable = true);

		// summary
		$groups[$group_name][] = HTMLHelper::_('select.option', 'sum', Text::_('MOD_TROMBINOSCOPE_VALUE_SUMMARY') . ' (Pro)', 'value', 'text', $disable = true);
